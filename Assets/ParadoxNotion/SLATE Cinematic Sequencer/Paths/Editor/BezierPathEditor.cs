...
namespace Slate
{
    ...
    public class BezierPathEditor : Editor
    {
        ...
        void DrawPointSceneGUI(BezierPoint point, int index) {
            ...
            var fmh_82_52_638969003019901195 = Quaternion.identity; Handles.FreeMoveHandle(point.position, pointGUISize, Vector3.zero, Handles.RectangleHandleCap);
            ...
            var fmh_90_76_638969003019935158 = Quaternion.identity; var newGlobal1 = Handles.FreeMoveHandle(point.handle1Position, HandleUtility.GetHandleSize(point.handle1Position) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
            ...
            var fmh_98_76_638969003019939560 = Quaternion.identity; var newGlobal2 = Handles.FreeMoveHandle(point.handle2Position, HandleUtility.GetHandleSize(point.handle2Position) * 0.075f, Vector3.zero, Handles.CircleHandleCap);
