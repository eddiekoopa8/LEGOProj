                ...
                for ( var k = 0; k < curveX.length; k++ ) {
                    ...
                    if ( kIndex == k ) {
                        if ( Tools.current == Tool.Move ) {
                            ...
                            var fmh_195_68_638969003022182967 = Quaternion.identity; newValue = Handles.FreeMoveHandle(pos, pointSize, Vector3.zero, Handles.RectangleHandleCap);
                        }
                    }
                    ...
                    if ( haveSameTangents && tangentMode == TangentMode.Editable ) {
                        ...
                        if ( kIndex == k ) {
                            ...
                            if ( k != 0 ) {
                                ...
                                var fmh_223_84_638969003022190595 = Quaternion.identity; var newInHandle = Handles.FreeMoveHandle(inHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
                            ...
                            if ( k < curveX.length - 1 ) {
                                ...
                                var fmh_249_86_638969003022244371 = Quaternion.identity; var newOutHandle = Handles.FreeMoveHandle(outHandle, handleSize, Vector3.zero, Handles.CircleHandleCap);
